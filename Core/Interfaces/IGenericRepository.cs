...
public interface IGenericRepository<T> where T : class
{
    ...
    Task<PaginationResponse<TResult>> GetAllAsync<TResult, TFilterParams, TQueryParams>(TQueryParams paginationParameters) where TQueryParams : QueryStringParameters;
